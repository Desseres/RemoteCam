...
namespace winrt::WindowsSample::implementation
{
    ...
    struct __declspec(uuid("D168A389-283B-4AD8-ACB4-1CC943368FA0"))
...
{
public:
    STDMETHODIMP CreateInstance(_In_ IUnknown* outer, _In_ REFIID riid, _COM_Outptr_ void** result) noexcept final try
    {
